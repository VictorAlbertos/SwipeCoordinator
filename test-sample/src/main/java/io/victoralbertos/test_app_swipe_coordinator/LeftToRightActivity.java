...
public final class LeftToRightActivity extends BaseSwipeCoordinatorActivity {

  @Override protected int idLayout() {
    return R.layout.left_right_swipe_activity;
  }

  @Override protected SwipeDirection swipeDirection() {
    return SwipeDirection.LEFT_TO_RIGHT;
  }
}
